...
with(argument0)
{
    ...
    if (asteroidHealth <= 0)
    {
        ...
        instance_create(x - (ASTEROID_MEDIUM_SPAWN_OFFSET_X / 2), y - (ASTEROID_MEDIUM_SPAWN_OFFSET_Y / 2), object_asteroid_small_jason);
        instance_create(x + (ASTEROID_MEDIUM_SPAWN_OFFSET_X / 2), y + (ASTEROID_MEDIUM_SPAWN_OFFSET_Y / 2), object_asteroid_small_jason);
        ...
        part_type_size(object_gameloop_jason.particleExplosion, 0.35 / 4, 0.35 / 4, 0.1, 0);
